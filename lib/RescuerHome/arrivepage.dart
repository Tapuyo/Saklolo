...
import 'package:sakloloresident/RescuerHome/alertlevel.dart';
import 'package:sakloloresident/RescuerHome/donepage.dart';

class ArrivePage extends StatefulWidget {
  String uid,name,lati,longi,address;
  ArrivePage(this.uid,this.name,this.lati,this.longi,this.address);
  @override
  _FindRescuerState createState() => _FindRescuerState(this.uid,this.name,this.lati,this.longi,this.address);
}

class _FindRescuerState extends State<ArrivePage> {
  String uid,name,lati,longi,address;
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Center(child: Text('YOU ARRIVE AT YOUR DESTINATION', style: TextStyle(fontSize: 16, color: Colors.blueAccent),))),
              SizedBox(height: 10,),
              Container(
              ...
              child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('Change Alert Level',  style: TextStyle(color: Colors.red, letterSpacing: 1.0,
                          fontFamily: "SanFrancisco", fontSize: 24, fontWeight: FontWeight.bold),
